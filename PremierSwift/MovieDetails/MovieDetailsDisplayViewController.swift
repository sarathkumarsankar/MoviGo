...
final class MovieDetailsDisplayViewController: UIViewController {
    ...
    init(movieDetails: MovieDetails, movies: [Movie]) {
    ...
    private class View: UIView {
        ...
        private lazy var contentStackView = UIStackView(arrangedSubviews: [backdropImageView, titleLabel, overviewLabel, collectionView])
