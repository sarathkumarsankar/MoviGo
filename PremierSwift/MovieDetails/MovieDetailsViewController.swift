...
final class MovieDetailsViewController: UIViewController {
    ...
    private func updateFromViewModel() {
        ...
        case .loaded(let movieDetails, let movie):
            self.showMovieDetails(movieDetails, similarMovie: movie)
        case .error:
            self.showError()
        }
    }
    ...
    private func showMovieDetails(_ movieDetails: MovieDetails, similarMovie: [Movie]) {
        let displayViewController = MovieDetailsDisplayViewController(movieDetails: movieDetails, movies: similarMovie)
